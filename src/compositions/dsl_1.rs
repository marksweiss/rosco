...
let env2 = a 0.1,0.8,exp d 0.3,0.6,lin s 0.8,0.4,lin r 1.0,0.0,exp
...
let chorus1 = chorus chorus_count 2 chorus_gains 0.5,0.5 dry_gain 0.0 chorus_delays 0.015,0.020 mod_freqs 0.25,0.33 mod_widths 0.003,0.004
let samp1 = samp:/Users/markweiss/Downloads/punk_computer/003/piano_note_1.wav:0.003:{step}
